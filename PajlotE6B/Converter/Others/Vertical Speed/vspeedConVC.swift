...
class vspeedConVC: UIViewController, UIPickerViewDelegate, UIPickerViewDataSource, UITextFieldDelegate {
    ...
    let list = VSpeedUnit.allCases()
    let shortList = ["m/s", "ft/min"]
    ...
    override func viewDidLoad() {
        ...
        tf_inputUnit.text = selectedUnits[3]
        tf_outputUnit.text = selectedUnits[3]
    ...
    @objc func convertVal (){
        ...
        let fromUnit = VSpeedUnit.fromString(list[fromUnitIdx])!
        let toUnit = VSpeedUnit.fromString(list[toUnitIdx])!
    ...
    @IBAction func inputValueSet(_ sender: Any) {
        //    convertVal()
    }
