...
class pressureConVC: UIViewController, UIPickerViewDelegate, UIPickerViewDataSource, UITextFieldDelegate {
    ...
    let list = PressureUnit.allCases()
    let shortList = ["hPa", "mmHg", "inHg"]
    ...
    override func viewDidLoad() {
        ...
        tf_inputUnit.text = selectedUnits[11]
        tf_outputUnit.text = selectedUnits[11]
    ...
    @objc func convertVal (){
        ...
        let fromUnit = PressureUnit.fromString(list[fromUnitIdx])!
        let toUnit = PressureUnit.fromString(list[toUnitIdx])!
