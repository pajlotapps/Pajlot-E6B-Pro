...
class weightConVC: UIViewController, UIPickerViewDelegate, UIPickerViewDataSource, UITextFieldDelegate {
    ...
    override func viewDidLoad() {
        ...
        tf_inputUnit.text = selectedUnits[9]
        tf_outputUnit.text = selectedUnits[9]
    ...
    @objc func convertVal (){
        ...
        let fromUnit = WeightUnit.fromString(list[fromUnitIdx])!
        let toUnit = WeightUnit.fromString(list[toUnitIdx])!
