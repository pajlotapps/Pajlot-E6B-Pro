...
class speedConVC: UIViewController, UIPickerViewDelegate, UIPickerViewDataSource, UITextFieldDelegate {
    ...
    let list = SpeedUnit.allCases()
    let shortList = ["KPH", "KT", "MPH"]
    ...
    override func viewDidLoad() {
        ...
        tf_inputUnit.text = selectedUnits[0]
        tf_outputUnit.text = selectedUnits[0]
    ...
    @objc func convertVal (){
        ...
        let fromUnit = SpeedUnit.fromString(list[fromUnitIdx])!
        let toUnit = SpeedUnit.fromString(list[toUnitIdx])!
