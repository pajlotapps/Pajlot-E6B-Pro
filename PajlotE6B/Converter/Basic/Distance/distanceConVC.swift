...
class distanceConVC: UIViewController, UIPickerViewDelegate, UIPickerViewDataSource, UITextFieldDelegate {
    ...
    let list = DistanceUnit.allCases()
    let shortList = ["km", "NM", "SM"]
    ...
    override func viewDidLoad() {
        ...
        tf_inputUnit.text = selectedUnits[1]
        tf_outputUnit.text = selectedUnits[1]
    ...
    @objc func convertVal (){
        ...
        let fromUnit = DistanceUnit.fromString(list[fromUnitIdx])!
        let toUnit = DistanceUnit.fromString(list[toUnitIdx])!
