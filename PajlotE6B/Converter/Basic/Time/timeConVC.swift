...
class timeConVC: UIViewController, UIPickerViewDelegate, UIPickerViewDataSource, UITextFieldDelegate {
    ...
    let list = TimeUnit.allCases()
    let shortList = ["hh:mm:ss", "mm:ss", "ss"]
    ...
    override func viewDidLoad() {
        ...
        tf_inputUnit.text = selectedUnits[2]
        tf_outputUnit.text = selectedUnits[2]
    ...
    @objc func convertVal (){
        ...
        let fromUnit = TimeUnit.fromString(list[fromUnitIdx])!
        let toUnit = TimeUnit.fromString(list[toUnitIdx])!
